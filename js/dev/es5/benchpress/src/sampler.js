System.register(["rtts_assert/rtts_assert", "angular2/src/facade/lang", "angular2/src/facade/async", "angular2/src/facade/collection", "angular2/di", "./metric", "./validator", "./reporter", "./web_driver_extension", "./web_driver_adapter", "./common_options", "./measure_values"], function($__export) {
  "use strict";
  var assert,
      isPresent,
      isBlank,
