System.register(["rtts_assert/rtts_assert", "angular2/test_lib", "angular2/src/render/dom/view/view_factory", "angular2/src/render/dom/view/proto_view", "angular2/src/render/dom/view/view"], function($__export) {
  "use strict";
  var assert,
      describe,
      ddescribe,
  ...
  function main() {
    function createViewFactory($__0) {
      ...
      return assert.returnType((new ViewFactory(capacity, null, null)), ViewFactory);
    }
    function createPv() {
