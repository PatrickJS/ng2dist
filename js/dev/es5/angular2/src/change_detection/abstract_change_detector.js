System.register(["rtts_assert/rtts_assert", "angular2/src/facade/lang", "angular2/src/facade/collection", "./binding_propagation_config", "./interfaces", "./constants"], function($__export) {
  "use strict";
  var assert,
      isPresent,
      List,
