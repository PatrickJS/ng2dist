System.register(["rtts_assert/rtts_assert", "angular2/di", "angular2/src/facade/lang", "angular2/src/facade/async", "angular2/src/facade/collection", "angular2/src/core/annotations/view", "angular2/src/core/compiler/template_resolver", "angular2/src/core/compiler/compiler", "angular2/src/core/compiler/view", "angular2/src/core/compiler/view_factory", "angular2/src/core/compiler/element_injector", "angular2/src/core/compiler/directive_metadata_reader", "./utils", "./lang_utils"], function($__export) {
  "use strict";
  var assert,
      Injector,
      bind,
      ...
      TestBed = $__export("TestBed", (function() {
        ...
        return ($traceurRuntime.createClass)(TestBed, {
          ...
          createView: function(component) {
            ...
            return assert.returnType((this._injector.get(Compiler).compileRoot(rootEl, componentBinding).then((function(pv) {
