System.register(["rtts_assert/rtts_assert", "angular2/src/dom/dom_adapter", "angular2/src/facade/collection", "angular2/src/facade/lang", "./view_container", "./proto_view", "../shadow_dom/light_dom", "../shadow_dom/content_tag", "angular2/src/render/dom/events/event_manager", "../shadow_dom/shadow_dom_strategy"], function($__export) {
  "use strict";
  var assert,
      DOM,
      ListWrapper,
      ...
      RenderView = $__export("RenderView", (function() {
        ...
        return ($traceurRuntime.createClass)(RenderView, {
          ...
          _createGlobalEventListener: function(elementIndex, eventName, eventTarget, fullName) {
            var $__0 = this;
            return assert.returnType((this.eventManager.addGlobalEventListener(eventTarget, eventName, (function(event) {
