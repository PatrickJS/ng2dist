System.register(["rtts_assert/rtts_assert", "angular2/angular2", "angular2/src/di/annotations", "angular2_material/src/components/radio/radio_dispatcher", "angular2_material/src/core/theme", "angular2/src/core/annotations/annotations", "angular2/src/facade/lang", "angular2/src/facade/math", "angular2/src/facade/collection"], function($__export) {
  "use strict";
  var assert,
      Component,
      View,
  ...
  return {
    ...
    execute: function() {
      _uniqueIdCounter = assert.type(0, assert.type.number);
