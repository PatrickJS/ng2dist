System.register(["rtts_assert/rtts_assert", "angular2/angular2", "angular2/src/core/annotations/di", "angular2/src/core/annotations/annotations", "angular2/src/facade/lang"], function($__export) {
  "use strict";
  var assert,
      Component,
      View,
    ...
    execute: function() {
      ...
      MdAnchor = $__export("MdAnchor", (function() {
        var MdAnchor = function MdAnchor(tabIndexSetter) {
          assert.argumentTypes(tabIndexSetter, Function);
