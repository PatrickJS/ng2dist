    ...
    describe('regression slope validator', (function() {
      ...
      function createValidator($__0) {
        var $__1 = $__0,
            size = $__1.size,
            metric = $__1.metric;
        validator = Injector.resolveAndCreate([RegressionSlopeValidator.BINDINGS, bind(RegressionSlopeValidator.METRIC).toValue(metric), bind(RegressionSlopeValidator.SAMPLE_SIZE).toValue(size)]).get(RegressionSlopeValidator);
      }
...
//# sourceMappingURL=regression_slope_validator_spec.es6.map

//# sourceMappingURL=./regression_slope_validator_spec.js.map