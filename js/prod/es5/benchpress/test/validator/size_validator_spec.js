  ...
  function main() {
    describe('size validator', (function() {
      ...
      function createValidator(size) {
        validator = Injector.resolveAndCreate([SizeValidator.BINDINGS, bind(SizeValidator.SAMPLE_SIZE).toValue(size)]).get(SizeValidator);
      }
...
//# sourceMappingURL=size_validator_spec.es6.map

//# sourceMappingURL=./size_validator_spec.js.map