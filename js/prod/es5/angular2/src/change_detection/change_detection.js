System.register(["./proto_change_detector", "./pipes/pipe_registry", "./pipes/iterable_changes", "./pipes/keyvalue_changes", "./pipes/null_pipe", "./constants", "./interfaces", "./pipes/pipe"], function($__export) {
  "use strict";
