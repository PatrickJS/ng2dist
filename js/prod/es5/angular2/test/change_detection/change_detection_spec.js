System.register(["angular2/test_lib", "angular2/src/facade/lang", "angular2/src/facade/collection", "angular2/src/change_detection/parser/parser", "angular2/src/change_detection/parser/lexer", "angular2/src/change_detection/parser/locals", "angular2/change_detection", "angular2/src/change_detection/proto_change_detector"], function($__export) {
  "use strict";
  var ddescribe,
      describe,
      it,
  ...
  return {
    ...
    execute: function() {
      ...
      FakePipeRegistry = (function($__super) {
        ...
        return ($traceurRuntime.createClass)(FakePipeRegistry, {get: function(type, obj, bpc) {
      ...
      FakeDirectives = (function() {
        ...
        return ($traceurRuntime.createClass)(FakeDirectives, {directive: function(directiveRecord) {
