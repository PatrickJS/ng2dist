System.register(["angular2/angular2", "angular2_material/src/components/button/button", "angular2/src/services/url_resolver", "../demo_common", "angular2/di"], function($__export) {
  "use strict";
  var bootstrap,
      Component,
      View,
