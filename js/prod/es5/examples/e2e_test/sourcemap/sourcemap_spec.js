      ...
      describe('sourcemaps', function() {
        ...
        it('should map sources', function() {
          ...
          browser.manage().logs().get('browser').then(function(logs) {
            ...
            var finalMapData = fs.readFileSync('dist/js/prod/es6/examples/src/sourcemap/index.map');
...
//# sourceMappingURL=sourcemap_spec.es6.map

//# sourceMappingURL=./sourcemap_spec.js.map