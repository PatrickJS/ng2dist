System.register(["angular2/src/render/dom/compiler/selector", "angular2/src/facade/lang", "angular2/src/facade/collection", "angular2/src/test_lib/benchmark_util", "angular2/src/dom/browser_adapter"], function($__export) {
  "use strict";
  var SelectorMatcher,
      CssSelector,
      StringWrapper,
  ...
  function main() {
    ...
    function match() {
      var matchCount = 0;
      for (var i = 0; i < count; i++) {
        fixedMatcher.match(fixedSelectors[i][0], (function(selector, selected) {
          matchCount += selected;
        }));
      }
      return matchCount;
...
//# sourceMappingURL=selector_benchmark.es6.map
